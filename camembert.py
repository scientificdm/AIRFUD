...
for j in range(10):
    ...
    for _ in trange(epochs, desc="Epoch"):  
        ...
        if val_f1 > best_f1:
            best_f1 = val_f1
            best_results = (count, val_acc, val_prec, val_rec, val_f1)
    ...
    print("\t - Validation Precision: {:.4f}".format(best_results[2]))
    print("\t - Validation Recall: {:.4f}".format(best_results[3]))
    print("\t - Validation F1-score: {:.4f}\n".format(best_results[4]))
    average_results.append(best_results)

print("\n-------------------------------------------------------")
print("\t - Averaged F1-score: {:.4f}\n".format(np.mean([i[4] for i in average_results])))
print("\t - Max F1-score: {:.4f}\n".format(np.max([i[4] for i in average_results])))
#%%